...
filename = './Transport-Mode-GPS-CNN/data/1_Trajectory_Label_Array.pickle'
...
new_trajectory_array = []
for count, dt in tqdm(enumerate(Trajectory_Label_Array)):                                                                                                                                                     
##for z in range(len(Trajectory_Label_Array)):                                                                                                                                                          

                                                                                                                                                                                                        
    Data = dt                                                                                                                                                                                           
    td = sorted(Data, key=taketime)                                                                                                                                                                     
    Data = np.array(td)                                                                                                                                                                                 
    ...
    for i in range(len(Data) - 1):
        ...
        try:
            tempSpeed.append(geodesic(A, B).meters/delta_time[i])
        except:
            print("A:",A,"B:",B,"delta_time[i]:",delta_time[i])
            flag = False
            break
    if not flag:
        continue
    ...
    for i in range(len(Data) - 1):                                                                                                                                                                      
        ci += 1
        tmp_trajectory.append(Data[i])                                                                                                                                                                  
        if (Data[i+1, 2] - Data[i, 2]) *24. * 3600 > min_trip_time:                                                                                                                                                 
            if ci >= 10:
                new_trajectory_array.append(np.array(tmp_trajectory))                                                                                                                                       
            tmp_trajectory = []                                                                                                                                                                         
            ci = 0
    if len(tmp_trajectory) >= 10:                                                                                                                                                                         
        new_trajectory_array.append(np.array(tmp_trajectory))                                                                                                                                           
print('new_traj_len:', len(new_trajectory_array)) 


#for i in tqdm(Trajectory_Label_Array):
for i in tqdm(new_trajectory_array):
##for z in range(len(Trajectory_Label_Array)):
    ...
    while i <= (len(Data) - 1):
        ...
        while i <= (len(Data) - 1) and Data[i, 3] == ModeType:
            Counter += 1
            index.append(i)
            i += 1
...
with open('25_sequence_Revised_InstanceCreation+NoJerkOutlier+Smoothing.pickle', 'wb') as f:
